...
1.6.0 is an intermediate build of the software. The code is untested
...
Instructions for unzipping 3D graphics API for the Java platform 1.6.0
----------------------------------------------------------------------

After downloading and unzipping the j3d-1_6_0-XXX.zip file
into a temporary directory, for example, "/tmp", you will see
the following files in the j3d-1_6_0-XXX directory:
