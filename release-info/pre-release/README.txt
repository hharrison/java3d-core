3D Graphics API for the Java Platform 1.5.3 Pre-Release
-------------------------------------------------------
...
1.5.3 is an intermediate build of the software. The code is untested
...
Instructions for unzipping 3D graphics API for the Java platform 1.5.3
----------------------------------------------------------------------

After downloading and unzipping the j3d-1_5_3-XXX.zip file
into a temporary directory, for example, "/tmp", you will see
the following files in the j3d-1_5_3-XXX directory:
